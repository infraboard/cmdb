...
type Bill struct {
	...
	RegionCode string `protobuf:"bytes,13,opt,name=region_code,json=regionCode,proto3" json:"region_code"`
	// 地域名称
	// @gotags: json:"region_name"
	RegionName string `protobuf:"bytes,14,opt,name=region_name,json=regionName,proto3" json:"region_name"`
	// 官网价
	// @gotags: json:"sale_price"
	SalePrice float64 `protobuf:"fixed64,15,opt,name=sale_price,json=salePrice,proto3" json:"sale_price"`
	// 优惠金额
	// @gotags: json:"save_cost"
	SaveCost float64 `protobuf:"fixed64,16,opt,name=save_cost,json=saveCost,proto3" json:"save_cost"`
	// 应付金额
	// @gotags: json:"real_cost"
	RealCost float64 `protobuf:"fixed64,17,opt,name=real_cost,json=realCost,proto3" json:"real_cost"`
	// 代金券抵扣
	// 腾讯对应: VoucherPayAmount
	// 阿里云: DeductedByCashCoupons
	VoucherPay float64 `protobuf:"fixed64,18,opt,name=voucher_pay,json=voucherPay,proto3" json:"voucher_pay,omitempty"`
	// 现金抵扣
	// @gotags: json:"cash_pay"
	CashPay float64 `protobuf:"fixed64,19,opt,name=cash_pay,json=cashPay,proto3" json:"cash_pay"`
	// 储值卡抵扣
	// @gotags: json:"bankcard_pay"
	BankcardPay float64 `protobuf:"fixed64,20,opt,name=bankcard_pay,json=bankcardPay,proto3" json:"bankcard_pay"`
	// 欠费金额
	// @gotags: json:"outstanding_amount"
	OutstandingAmount float64 `protobuf:"fixed64,21,opt,name=outstanding_amount,json=outstandingAmount,proto3" json:"outstanding_amount"`
}
...
func (x *Bill) GetBankcardPay() float64 {
	if x != nil {
		return x.BankcardPay
	}
	return 0
}
...
var file_app_bill_pb_bill_proto_rawDesc = []byte{
	...
	0x05, 0x0a, 0x04, 0x42, 0x69, 0x6c, 0x6c, 0x12, 0x38, 0x0a, 0x06, 0x76, 0x65, 0x6e, 0x64, 0x6f,
	...
	,
	...
	0x6c, 0x6c, 0x2e, 0x42, 0x69, 0x6c, 0x6c, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x9e,
	0x02, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42, 0x69, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x38, 0x0a, 0x06, 0x76,
	0x65, 0x6e, 0x64, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x69, 0x6e,
	0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x56, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x52, 0x06, 0x76,
	0x65, 0x6e, 0x64, 0x6f, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x6f, 0x6e, 0x74, 0x68, 0x18, 0x03,
	...
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0b, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x1f,
	...
	0xa5, 0x01, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x44, 0x0a, 0x08, 0x53,
	0x61, 0x76, 0x65, 0x42, 0x69, 0x6c, 0x6c, 0x12, 0x1a, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x62, 0x69, 0x6c, 0x6c, 0x2e, 0x42,
	0x69, 0x6c, 0x6c, 0x1a, 0x1a, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64,
	0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x62, 0x69, 0x6c, 0x6c, 0x2e, 0x42, 0x69, 0x6c, 0x6c, 0x22,
	0x00, 0x12, 0x54, 0x0a, 0x09, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42, 0x69, 0x6c, 0x6c, 0x12, 0x26,
	...
	0x6c, 0x6c, 0x53, 0x65, 0x74, 0x22, 0x00, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64,
	0x2f, 0x63, 0x6d, 0x64, 0x62, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x62, 0x69, 0x6c, 0x6c, 0x62, 0x06,
...
var file_app_bill_pb_bill_proto_goTypes = []interface{}{
	...
	(resource.Vendor)(0),     // 3: infraboard.cmdb.resource.Vendor
	(*page.PageRequest)(nil), // 4: infraboard.mcube.page.PageRequest
}
var file_app_bill_pb_bill_proto_depIdxs = []int32{
	3, // 0: infraboard.cmdb.bill.Bill.vendor:type_name -> infraboard.cmdb.resource.Vendor
	0, // 1: infraboard.cmdb.bill.BillSet.items:type_name -> infraboard.cmdb.bill.Bill
	4, // 2: infraboard.cmdb.bill.QueryBillRequest.page:type_name -> infraboard.mcube.page.PageRequest
	3, // 3: infraboard.cmdb.bill.QueryBillRequest.vendor:type_name -> infraboard.cmdb.resource.Vendor
	0, // 4: infraboard.cmdb.bill.Service.SaveBill:input_type -> infraboard.cmdb.bill.Bill
	2, // 5: infraboard.cmdb.bill.Service.QueryBill:input_type -> infraboard.cmdb.bill.QueryBillRequest
	0, // 6: infraboard.cmdb.bill.Service.SaveBill:output_type -> infraboard.cmdb.bill.Bill
	1, // 7: infraboard.cmdb.bill.Service.QueryBill:output_type -> infraboard.cmdb.bill.BillSet
