...
type Bill struct {
	...
	SalePrice float32 `protobuf:"fixed32,15,opt,name=sale_price,json=salePrice,proto3" json:"sale_price"`
	// 优惠金额
	// @gotags: json:"save_cost"
	SaveCost float32 `protobuf:"fixed32,16,opt,name=save_cost,json=saveCost,proto3" json:"save_cost"`
	// 应付金额
	// @gotags: json:"real_cost"
	RealCost float32 `protobuf:"fixed32,17,opt,name=real_cost,json=realCost,proto3" json:"real_cost"`
	// 代金券抵扣
	// 腾讯对应: VoucherPayAmount
	// 阿里云: DeductedByCashCoupons
	VoucherPay float32 `protobuf:"fixed32,18,opt,name=voucher_pay,json=voucherPay,proto3" json:"voucher_pay,omitempty"`
	// 现金抵扣
	// @gotags: json:"cash_pay"
	CashPay float32 `protobuf:"fixed32,19,opt,name=cash_pay,json=cashPay,proto3" json:"cash_pay"`
	// 储值卡抵扣
	// @gotags: json:"bankcard_pay"
	BankcardPay float32 `protobuf:"fixed32,20,opt,name=bankcard_pay,json=bankcardPay,proto3" json:"bankcard_pay"`
	// 欠费金额
	// @gotags: json:"outstanding_amount"
	OutstandingAmount float32 `protobuf:"fixed32,21,opt,name=outstanding_amount,json=outstandingAmount,proto3" json:"outstanding_amount"`
}
...
func (x *Bill) GetAccountName() string {
	if x != nil {
...
func (x *Bill) GetSalePrice() float32 {
	if x != nil {
		return x.SalePrice
	}
	return 0
...
func (x *Bill) GetSaveCost() float32 {
	if x != nil {
		return x.SaveCost
	}
	return 0
...
func (x *Bill) GetRealCost() float32 {
	if x != nil {
		return x.RealCost
	}
	return 0
...
func (x *Bill) GetVoucherPay() float32 {
	if x != nil {
		return x.VoucherPay
	}
	return 0
...
func (x *Bill) GetCashPay() float32 {
	if x != nil {
		return x.CashPay
	}
	return 0
...
func (x *Bill) GetBankcardPay() float32 {
	if x != nil {
...
func (x *Bill) GetOutstandingAmount() float32 {
	if x != nil {
...
var file_app_bill_pb_bill_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x6d, 0x6f, 0x6e, 0x74, 0x68, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x72, 0x6f,
	...
	,
