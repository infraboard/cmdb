...
type Bill struct {
	...
	CreditPay float64 `protobuf:"fixed64,18,opt,name=credit_pay,json=creditPay,proto3" json:"credit_pay"`
	// 代金券抵扣
	// 腾讯对应: VoucherPayAmount
	// 阿里云: DeductedByCashCoupons
	VoucherPay float64 `protobuf:"fixed64,19,opt,name=voucher_pay,json=voucherPay,proto3" json:"voucher_pay,omitempty"`
	// 现金抵扣
	// @gotags: json:"cash_pay"
	CashPay float64 `protobuf:"fixed64,20,opt,name=cash_pay,json=cashPay,proto3" json:"cash_pay"`
	// 储值卡抵扣
	// @gotags: json:"storedcard_pay"
	StoredcardPay float64 `protobuf:"fixed64,21,opt,name=storedcard_pay,json=storedcardPay,proto3" json:"storedcard_pay"`
	// 欠费金额
	// @gotags: json:"outstanding_amount"
	OutstandingAmount float64 `protobuf:"fixed64,22,opt,name=outstanding_amount,json=outstandingAmount,proto3" json:"outstanding_amount"`
}
...
var file_app_bill_pb_bill_proto_rawDesc = []byte{
	...
	,
	...
	0x73, 0x22, 0x9e, 0x02, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42, 0x69, 0x6c, 0x6c, 0x52,
	...
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x38,
	...
	0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x6f, 0x6e, 0x74, 0x68, 0x12, 0x1d,
	...
	0x49, 0x64, 0x32, 0xa5, 0x01, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x44,
	0x0a, 0x08, 0x53, 0x61, 0x76, 0x65, 0x42, 0x69, 0x6c, 0x6c, 0x12, 0x1a, 0x2e, 0x69, 0x6e, 0x66,
	...
	0x6c, 0x6c, 0x22, 0x00, 0x12, 0x54, 0x0a, 0x09, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42, 0x69, 0x6c,
	...
	0x2e, 0x42, 0x69, 0x6c, 0x6c, 0x53, 0x65, 0x74, 0x22, 0x00, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f,
	0x61, 0x72, 0x64, 0x2f, 0x63, 0x6d, 0x64, 0x62, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x62, 0x69, 0x6c,
