...
func (o *ALBOperator) DescribeLoadBalancer(ctx context.Context, r *provider.DescribeRequest) (
	*lb.LoadBalancer, error) {
	...
	if set.Length() == 0 {
		return nil, exception.NewNotFound("alb %s not found", r.Id)
	}

	return set.Items[0], nil
}

func (o *ALBOperator) PageQueryLoadBalancer(req *provider.QueryRequest) pager.Pager {
	p := newPager(o)
...
// 查询已创建的负载均衡实例
// 参考: https://next.api.aliyun.com/api/Alb/2020-06-16/ListLoadBalancers
func (o *ALBOperator) QueryLoadBalancer(req *alb.ListLoadBalancersRequest) (*lb.LoadBalancerSet, error) {
...
func (o *ALBOperator) transferLoadBalancerSet(items []*alb.ListLoadBalancersResponseBodyLoadBalancers) *lb.LoadBalancerSet {
	set := lb.NewLoadBalancerSet()
	for i := range items {
...
func (o *ALBOperator) transferLoadBalancer(ins *alb.ListLoadBalancersResponseBodyLoadBalancers) *lb.LoadBalancer {
