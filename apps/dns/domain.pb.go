...
var file_apps_dns_pb_domain_proto_rawDesc = []byte{
	...
	0x6e, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0xdb, 0x01, 0x0a, 0x06, 0x52, 0x65, 0x63,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x57, 0x0a, 0x09, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x53, 0x65, 0x74, 0x12, 0x34, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e,
	0x63, 0x6d, 0x64, 0x62, 0x2e, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x52, 0x65, 0x63, 0x6f,
...
var file_apps_dns_pb_domain_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_apps_dns_pb_domain_proto_goTypes = []interface{}{
	...
	(*Record)(nil),            // 3: infraboard.cmdb.domain.Record
	(*RecordSet)(nil),         // 4: infraboard.cmdb.domain.RecordSet
	(*resource.Resource)(nil), // 5: infraboard.cmdb.resource.Resource
}
var file_apps_dns_pb_domain_proto_depIdxs = []int32{
	5, // 0: infraboard.cmdb.domain.Domain.resource:type_name -> infraboard.cmdb.resource.Resource
	4, // 1: infraboard.cmdb.domain.Domain.records:type_name -> infraboard.cmdb.domain.RecordSet
	0, // 2: infraboard.cmdb.domain.DomainSet.items:type_name -> infraboard.cmdb.domain.Domain
	3, // 3: infraboard.cmdb.domain.RecordSet.items:type_name -> infraboard.cmdb.domain.Record
