...
type Information struct {
	...
	// 资源使用的内存
	// @gotags: json:"memory"
	Memory int32 `protobuf:"varint,10,opt,name=memory,proto3" json:"memory"`
	// 资源使用的存储
	// @gotags: json:"storage"
	Storage int32 `protobuf:"varint,11,opt,name=storage,proto3" json:"storage"`
	// 资源访问地址
	// 公网IP, 或者域名
	// @gotags: json:"public_ip"
	PublicIp []string `protobuf:"bytes,12,rep,name=public_ip,json=publicIp,proto3" json:"public_ip"`
	// 公网IP带宽, 单位M
	// @gotags: json:"band_width"
	BandWidth int32 `protobuf:"varint,13,opt,name=band_width,json=bandWidth,proto3" json:"band_width"`
	// 内网IP, 或者域名
	// @gotags: json:"private_ip"
	PrivateIp []string `protobuf:"bytes,14,rep,name=private_ip,json=privateIp,proto3" json:"private_ip"`
	// 实例付费方式
	// @gotags: json:"pay_mode"
	PayMode PayMode `protobuf:"varint,15,opt,name=pay_mode,json=payMode,proto3,enum=infraboard.cmdb.resource.PayMode" json:"pay_mode"`
	// 付费方式详情
	// @gotags: json:"pay_mode_detail"
	PayModeDetail string `protobuf:"bytes,16,opt,name=pay_mode_detail,json=payModeDetail,proto3" json:"pay_mode_detail"`
	// 序列号
	// @gotags: json:"serial_number"
	SerialNumber string `protobuf:"bytes,17,opt,name=serial_number,json=serialNumber,proto3" json:"serial_number"`
	// 额外的通用属性
	// @gotags: json:"extra"
...
var file_apps_resource_pb_resource_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x09, 0x74, 0x61, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x87, 0x05,
	...
	,
	...
	0x6d, 0x6f, 0x64, 0x65, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x18, 0x10, 0x20, 0x01, 0x28,
	...
	0x72, 0x18, 0x11, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x4e,
