...
type Information struct {
	...
	LockMode string `protobuf:"bytes,9,opt,name=lock_mode,json=lockMode,proto3" json:"lock_mode"`
	// 锁定原因
	// @gotags: json:"lock_reason"
	LockReason string `protobuf:"bytes,10,opt,name=lock_reason,json=lockReason,proto3" json:"lock_reason"`
	// 资源通用配置
	// @gotags: json:"cpu"
	// 资源占用Cpu数量
	...
	// 资源使用的存储
	// @gotags: json:"storage"
	Storage int32 `protobuf:"varint,14,opt,name=storage,proto3" json:"storage"`
	// 资源访问地址
	// 公网IP, 或者域名
	// @gotags: json:"public_ip"
	PublicIp []string `protobuf:"bytes,15,rep,name=public_ip,json=publicIp,proto3" json:"public_ip"`
	// 公网IP带宽, 单位M
	// @gotags: json:"band_width"
	BandWidth int32 `protobuf:"varint,16,opt,name=band_width,json=bandWidth,proto3" json:"band_width"`
	// 内网IP, 或者域名
	// @gotags: json:"private_ip"
	PrivateIp []string `protobuf:"bytes,17,rep,name=private_ip,json=privateIp,proto3" json:"private_ip"`
	// 实例付费方式
	// @gotags: json:"pay_mode"
	PayMode PayMode `protobuf:"varint,18,opt,name=pay_mode,json=payMode,proto3,enum=infraboard.cmdb.resource.PayMode" json:"pay_mode"`
	// 付费方式详情
	// @gotags: json:"pay_mode_detail"
	PayModeDetail string `protobuf:"bytes,19,opt,name=pay_mode_detail,json=payModeDetail,proto3" json:"pay_mode_detail"`
	// 序列号
	// @gotags: json:"serial_number"
	SerialNumber string `protobuf:"bytes,20,opt,name=serial_number,json=serialNumber,proto3" json:"serial_number"`
	// 额外的通用属性
	// @gotags: json:"extra"
...
func (x *Information) GetLockMode() string {
	if x != nil {
		return x.LockMode
	}
	return ""
...
func (x *Information) GetLockReason() string {
	if x != nil {
		return x.LockReason
	}
	return ""
...
func (x *Information) GetCpu() int32 {
	if x != nil {
		return x.Cpu
	}
	return 0
...
func (x *Information) GetGpu() int32 {
	if x != nil {
		return x.Gpu
	}
	return 0
...
func (x *Information) GetMemory() int32 {
	if x != nil {
		return x.Memory
	}
	return 0
...
func (x *Information) GetStorage() int32 {
	if x != nil {
		return x.Storage
	}
	return 0
...
func (x *Information) GetBandWidth() int32 {
	if x != nil {
		return x.BandWidth
	}
	return 0
...
func (x *Information) GetSerialNumber() string {
	if x != nil {
...
func (x *Information) GetExtra() map[string]string {
	if x != nil {
		return x.Extra
	}
	return nil
...
type Cost struct {
	...
	RealCost float64 `protobuf:"fixed64,2,opt,name=real_cost,json=realCost,proto3" json:"real_cost"`
	// 折扣率
	// @gotags: json:"policy"
	Policy float64 `protobuf:"fixed64,3,opt,name=policy,proto3" json:"policy"`
	// 单价（分）
	// @gotags: json:"unit_price"
	UnitPrice float64 `protobuf:"fixed64,4,opt,name=unit_price,json=unitPrice,proto3" json:"unit_price"`
}
...
var file_apps_resource_pb_resource_proto_rawDesc = []byte{
	...
	0x72, 0x63, 0x65, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0xee, 0x01, 0x0a, 0x08, 0x52,
	...
	0x73, 0x74, 0x52, 0x04, 0x63, 0x6f, 0x73, 0x74, 0x12, 0x31, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73,
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f,
	0x61, 0x72, 0x64, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x2e, 0x54, 0x61, 0x67, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x22, 0xa7, 0x05, 0x0a, 0x04,
	...
	0x28, 0x09, 0x52, 0x09, 0x74, 0x61, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xd7, 0x05,
	...
	,
	...
	0x6d, 0x6f, 0x64, 0x65, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x18, 0x13, 0x20, 0x01, 0x28,
	...
	0x72, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x4e,
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x46, 0x0a, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x1a,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72,
	0x64, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e,
	0x49, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x45, 0x78, 0x74, 0x72,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xe1, 0x02, 0x0a, 0x03, 0x54, 0x61, 0x67, 0x12,
	...
	0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x54, 0x41, 0x47, 0x5f, 0x54, 0x59,
	0x50, 0x45, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18,
	...
	0x69, 0x64, 0x64, 0x65, 0x6e, 0x12, 0x3b, 0x0a, 0x04, 0x6d, 0x65, 0x74, 0x61, 0x18, 0x0f, 0x20,
	...
	,
	...
	0x6e, 0x76, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x65, 0x6e, 0x76, 0x12, 0x47, 0x0a,
	0x0a, 0x75, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x23, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x63,
	...
	,
	...
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x69,
	0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x31, 0x0a, 0x04,
	0x74, 0x61, 0x67, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x69, 0x6e, 0x66,
	0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x54, 0x61, 0x67, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x22,
	...
	0x63, 0x65, 0x49, 0x64, 0x73, 0x2a, 0x46, 0x0a, 0x06, 0x56, 0x45, 0x4e, 0x44, 0x4f, 0x52, 0x12,
	...
	,
	...
	0x2a, 0x3d, 0x0a, 0x08, 0x54, 0x41, 0x47, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x12, 0x08, 0x0a, 0x04,
	0x55, 0x53, 0x45, 0x52, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x54, 0x48, 0x49, 0x52, 0x44, 0x10,
	0x01, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x59, 0x53, 0x54, 0x45, 0x4d, 0x10, 0x02, 0x12, 0x10, 0x0a,
	0x0c, 0x52, 0x45, 0x46, 0x5f, 0x52, 0x45, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x10, 0x03, 0x2a,
	0x23, 0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x07, 0x0a, 0x03, 0x41, 0x44, 0x44, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x52, 0x45, 0x4d, 0x4f,
	0x56, 0x45, 0x10, 0x01, 0x32, 0x99, 0x02, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x65, 0x74, 0x12, 0x57, 0x0a, 0x08, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x54, 0x61, 0x67, 0x12, 0x29, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f,
	0x61, 0x72, 0x64, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x61, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x20, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x63,
	0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x54, 0x61, 0x67,
	0x53, 0x65, 0x74, 0x12, 0x5b, 0x0a, 0x09, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x61, 0x67,
	...
	0x74, 0x65, 0x54, 0x61, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x69,
	0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72,
	...
	0x70, 0x70, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_apps_resource_pb_resource_proto_goTypes = []interface{}{
	...
	(*Information)(nil),         // 10: infraboard.cmdb.resource.Information
	(*Tag)(nil),                 // 11: infraboard.cmdb.resource.Tag
	(*TagSet)(nil),              // 12: infraboard.cmdb.resource.TagSet
	(*Cost)(nil),                // 13: infraboard.cmdb.resource.Cost
	(*SearchRequest)(nil),       // 14: infraboard.cmdb.resource.SearchRequest
	(*TagSelector)(nil),         // 15: infraboard.cmdb.resource.TagSelector
	(*UpdateTagRequest)(nil),    // 16: infraboard.cmdb.resource.UpdateTagRequest
	(*QueryTagRequest)(nil),     // 17: infraboard.cmdb.resource.QueryTagRequest
	nil,                         // 18: infraboard.cmdb.resource.Information.ExtraEntry
...
var file_apps_resource_pb_resource_proto_depIdxs = []int32{
	...
	10, // 2: infraboard.cmdb.resource.Resource.information:type_name -> infraboard.cmdb.resource.Information
	13, // 3: infraboard.cmdb.resource.Resource.cost:type_name -> infraboard.cmdb.resource.Cost
	11, // 4: infraboard.cmdb.resource.Resource.tags:type_name -> infraboard.cmdb.resource.Tag
	...
	9,  // 8: infraboard.cmdb.resource.Base.shared_policy:type_name -> infraboard.cmdb.resource.SharedPolicy
	2,  // 9: infraboard.cmdb.resource.Information.pay_mode:type_name -> infraboard.cmdb.resource.PayMode
	18, // 10: infraboard.cmdb.resource.Information.extra:type_name -> infraboard.cmdb.resource.Information.ExtraEntry
	...
	11, // 13: infraboard.cmdb.resource.TagSet.items:type_name -> infraboard.cmdb.resource.Tag
	...
	15, // 18: infraboard.cmdb.resource.SearchRequest.tags:type_name -> infraboard.cmdb.resource.TagSelector
	5,  // 19: infraboard.cmdb.resource.UpdateTagRequest.action:type_name -> infraboard.cmdb.resource.UpdateAction
	11, // 20: infraboard.cmdb.resource.UpdateTagRequest.tags:type_name -> infraboard.cmdb.resource.Tag
	14, // 21: infraboard.cmdb.resource.Service.Search:input_type -> infraboard.cmdb.resource.SearchRequest
	17, // 22: infraboard.cmdb.resource.Service.QueryTag:input_type -> infraboard.cmdb.resource.QueryTagRequest
	16, // 23: infraboard.cmdb.resource.Service.UpdateTag:input_type -> infraboard.cmdb.resource.UpdateTagRequest
	6,  // 24: infraboard.cmdb.resource.Service.Search:output_type -> infraboard.cmdb.resource.ResourceSet
	12, // 25: infraboard.cmdb.resource.Service.QueryTag:output_type -> infraboard.cmdb.resource.TagSet
...
func file_apps_resource_pb_resource_proto_init() {
	...
	file_apps_resource_pb_resource_proto_msgTypes[8].OneofWrappers = []interface{}{}
	type x struct{}
