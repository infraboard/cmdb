...
var file_apps_bill_pb_bill_proto_rawDesc = []byte{
	...
	0x22, 0x88, 0x07, 0x0a, 0x04, 0x42, 0x69, 0x6c, 0x6c, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x61, 0x73,
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x7f, 0x0a, 0x07, 0x42,
...
var file_apps_bill_pb_bill_proto_goTypes = []interface{}{
	...
	(*Cost)(nil),                // 2: infraboard.cmdb.bill.Cost
	(*QueryBillRequest)(nil),    // 3: infraboard.cmdb.bill.QueryBillRequest
	(*DeleteBillRequest)(nil),   // 4: infraboard.cmdb.bill.DeleteBillRequest
	(*ConfirmBillRequest)(nil),  // 5: infraboard.cmdb.bill.ConfirmBillRequest
	nil,                         // 6: infraboard.cmdb.bill.Bill.ExtraEntry
	(resource.Vendor)(0),        // 7: infraboard.cmdb.resource.Vendor
	(*resource.Tag)(nil),        // 8: infraboard.cmdb.resource.Tag
...
var file_apps_bill_pb_bill_proto_depIdxs = []int32{
	...
	8,  // 1: infraboard.cmdb.bill.Bill.tags:type_name -> infraboard.cmdb.resource.Tag
	2,  // 2: infraboard.cmdb.bill.Bill.cost:type_name -> infraboard.cmdb.bill.Cost
	6,  // 3: infraboard.cmdb.bill.Bill.extra:type_name -> infraboard.cmdb.bill.Bill.ExtraEntry
	2,  // 4: infraboard.cmdb.bill.BillSet.sum:type_name -> infraboard.cmdb.bill.Cost
	0,  // 5: infraboard.cmdb.bill.BillSet.items:type_name -> infraboard.cmdb.bill.Bill
	9,  // 6: infraboard.cmdb.bill.QueryBillRequest.page:type_name -> infraboard.mcube.page.PageRequest
	7,  // 7: infraboard.cmdb.bill.QueryBillRequest.vendor:type_name -> infraboard.cmdb.resource.Vendor
	8,  // 8: infraboard.cmdb.bill.QueryBillRequest.tags:type_name -> infraboard.cmdb.resource.Tag
	0,  // 9: infraboard.cmdb.bill.Service.SyncBill:input_type -> infraboard.cmdb.bill.Bill
	3,  // 10: infraboard.cmdb.bill.Service.QueryBill:input_type -> infraboard.cmdb.bill.QueryBillRequest
	5,  // 11: infraboard.cmdb.bill.Service.ConfirmBill:input_type -> infraboard.cmdb.bill.ConfirmBillRequest
	4,  // 12: infraboard.cmdb.bill.Service.DeleteBill:input_type -> infraboard.cmdb.bill.DeleteBillRequest
	0,  // 13: infraboard.cmdb.bill.Service.SyncBill:output_type -> infraboard.cmdb.bill.Bill
	1,  // 14: infraboard.cmdb.bill.Service.QueryBill:output_type -> infraboard.cmdb.bill.BillSet
	1,  // 15: infraboard.cmdb.bill.Service.ConfirmBill:output_type -> infraboard.cmdb.bill.BillSet
	1,  // 16: infraboard.cmdb.bill.Service.DeleteBill:output_type -> infraboard.cmdb.bill.BillSet
