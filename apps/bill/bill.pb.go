...
type DeleteBillRequest struct {
	...
	// 账号Id
	// @gotags: json:"account_id" validate:"required"
	AccountId string `protobuf:"bytes,1,opt,name=account_id,json=accountId,proto3" json:"account_id" validate:"required"`
	// 账单的月份
	// @gotags: json:"month"
	Month string `protobuf:"bytes,2,opt,name=month,proto3" json:"month"`
	// 账单的月份
...
var file_apps_bill_pb_bill_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x22, 0x61, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x42, 0x69, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x68, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x64, 0x32, 0xf7, 0x01, 0x0a, 0x07, 0x53,
...
var file_apps_bill_pb_bill_proto_goTypes = []interface{}{
	...
	(*resource.Tag)(nil),        // 6: infraboard.cmdb.resource.Tag
...
var file_apps_bill_pb_bill_proto_depIdxs = []int32{
	...
	6,  // 1: infraboard.cmdb.bill.Bill.tags:type_name -> infraboard.cmdb.resource.Tag
	4,  // 2: infraboard.cmdb.bill.Bill.extra:type_name -> infraboard.cmdb.bill.Bill.ExtraEntry
	0,  // 3: infraboard.cmdb.bill.BillSet.items:type_name -> infraboard.cmdb.bill.Bill
	7,  // 4: infraboard.cmdb.bill.QueryBillRequest.page:type_name -> infraboard.mcube.page.PageRequest
	5,  // 5: infraboard.cmdb.bill.QueryBillRequest.vendor:type_name -> infraboard.cmdb.resource.Vendor
	6,  // 6: infraboard.cmdb.bill.QueryBillRequest.tags:type_name -> infraboard.cmdb.resource.Tag
	...
	3,  // 9: infraboard.cmdb.bill.Service.DeleteBill:input_type -> infraboard.cmdb.bill.DeleteBillRequest
	0,  // 10: infraboard.cmdb.bill.Service.SyncBill:output_type -> infraboard.cmdb.bill.Bill
	1,  // 11: infraboard.cmdb.bill.Service.QueryBill:output_type -> infraboard.cmdb.bill.BillSet
	1,  // 12: infraboard.cmdb.bill.Service.DeleteBill:output_type -> infraboard.cmdb.bill.BillSet
