...
const (
	...
	// 付费方式调整
	ORDER_TYPE_MODIFY ORDER_TYPE = 5
)
...
type Order struct {
	...
	OrderType ORDER_TYPE `protobuf:"varint,5,opt,name=order_type,json=orderType,proto3,enum=infraboard.cmdb.order.ORDER_TYPE" json:"order_type"`
	// 订单状态
	// @gotags: json:"status"
	...
	// 定义费用
	// @gotags: json:"cost"
	Cost *Cost `protobuf:"bytes,11,opt,name=cost,proto3" json:"cost"`
	// 产品编码
	...
	ProductName string `protobuf:"bytes,13,opt,name=product_name,json=productName,proto3" json:"product_name"`
	// 子产品编码
	// @gotags: json:"sub_product_code"
	SubProductCode string `protobuf:"bytes,14,opt,name=sub_product_code,json=subProductCode,proto3" json:"sub_product_code"`
	// 子产品编码中文名称
	// @gotags: json:"sub_product_name"
	SubProductName string `protobuf:"bytes,15,opt,name=sub_product_name,json=subProductName,proto3" json:"sub_product_name"`
	// 购买产品详情
	// @gotags: json:"product_info"
	ProductInfo string `protobuf:"bytes,16,opt,name=product_info,json=productInfo,proto3" json:"product_info"`
	// 订单对应的资源id
	// @gotags: json:"resource_id"
	ResourceId []string `protobuf:"bytes,17,rep,name=resource_id,json=resourceId,proto3" json:"resource_id"`
}
...
func (x *Order) GetPayMode() string {
	if x != nil {
		return x.PayMode
	}
	return ""
...
type Cost struct {
	...
	UnitPrice float64 `protobuf:"fixed64,2,opt,name=unit_price,json=unitPrice,proto3" json:"unit_price"`
	// 实际支付金额（分）
	...
	VoucherPay float64 `protobuf:"fixed64,4,opt,name=voucher_pay,json=voucherPay,proto3" json:"voucher_pay,omitempty"`
	// 折扣率
	// @gotags: json:"policy"
...
var file_apps_order_pb_order_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xe0, 0x04, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x17, 0x0a,
	0x07, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x74, 0x61, 0x73, 0x6b, 0x49, 0x64, 0x12, 0x38, 0x0a, 0x06, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f,
	...
	0x12, 0x20, 0x0a, 0x0c, 0x62, 0x69, 0x67, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x62, 0x69, 0x67, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x49, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02,
	0x69, 0x64, 0x12, 0x40, 0x0a, 0x0a, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f,
	0x61, 0x72, 0x64, 0x2e, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x4f,
	0x52, 0x44, 0x45, 0x52, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x52, 0x09, 0x6f, 0x72, 0x64, 0x65, 0x72,
	...
	0x70, 0x61, 0x79, 0x65, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x61, 0x79,
	...
	,
	...
	,
...
var file_apps_order_pb_order_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_apps_order_pb_order_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_apps_order_pb_order_proto_goTypes = []interface{}{
	(ORDER_TYPE)(0),      // 0: infraboard.cmdb.order.ORDER_TYPE
	(*Order)(nil),        // 1: infraboard.cmdb.order.Order
	(*Cost)(nil),         // 2: infraboard.cmdb.order.Cost
	(resource.VENDOR)(0), // 3: infraboard.cmdb.resource.VENDOR
}
var file_apps_order_pb_order_proto_depIdxs = []int32{
	3, // 0: infraboard.cmdb.order.Order.vendor:type_name -> infraboard.cmdb.resource.VENDOR
	0, // 1: infraboard.cmdb.order.Order.order_type:type_name -> infraboard.cmdb.order.ORDER_TYPE
	2, // 2: infraboard.cmdb.order.Order.cost:type_name -> infraboard.cmdb.order.Cost
